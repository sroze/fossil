          ...
          schema: {
            ...
            items: {
              ...
              properties: {
                ...
                data: { type: 'object', description: 'JSON-encoded event.' },
              },
            },
          },
        },
...
export class SubscribeController {
  ...
  @ApiOperation({
    ...
    operationId: 'listenCategory',
  })
  @ServerSentEventsOperation()
  @Get('stores/:id/categories/:category/sse-stream')
  ...
  @ServerSentEventsOperation()
  @Get('stores/:id/streams/:stream/sse-stream')
